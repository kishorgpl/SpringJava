...
import com.techm.springmvc.model.Employee;
import com.techm.springmvc.service.EmployeeService;
...
public class AppControllerTest {
	 ...
	 * 
	 * @Mock MessageSource message;
	 * 
	 * @InjectMocks AppController appController;
	 * 
	 ...
	 * 
	 * @Test public void listEmployees(){
	 * when(service.findAllEmployees()).thenReturn(employees);
	 * Assert.assertEquals(appController.listEmployees(model), "allemployees");
	 * Assert.assertEquals(model.get("employees"), employees); verify(service,
	 * atLeastOnce()).findAllEmployees(); }
	 * 
