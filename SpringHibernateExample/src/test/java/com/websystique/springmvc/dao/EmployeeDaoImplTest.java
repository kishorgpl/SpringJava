...
public class EmployeeDaoImplTest //extends EntityDaoImplTest 
{
	 ...
	 * 
	 * @Override protected IDataSet getDataSet() throws Exception{ IDataSet dataSet
	 * = new FlatXmlDataSet(this.getClass().getClassLoader().getResourceAsStream(
	 * "Employee.xml")); return dataSet; }
	 * 
	 ...
	 * 
	 * 
	 * @Test public void findById(){ Assert.assertNotNull(employeeDao.findById(1));
	 ...
	 * 
	 * public Employee getSampleEmployee(){ Employee employee = new Employee();
	 * employee.setName("Karen"); employee.setSsn("12345"); employee.setSalary(new
	 * BigDecimal(10980)); employee.setJoiningDate(new LocalDate()); return
	 * employee; }
	 * 
	 */}
